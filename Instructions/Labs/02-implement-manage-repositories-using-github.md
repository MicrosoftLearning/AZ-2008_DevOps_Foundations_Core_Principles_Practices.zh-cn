...
在本练习中，你将使用 GitHub 分支 Git 存储库并对其进行管理。
...
1. 在“**添加标题**”文本框中，输入 **index.html 看起来相当紧缩**。
1. 在“**添加说明**”文本框中，输入 **index.html 文件可以使用新式触摸**。
...
1. 在“**查找或创建分支...**”文本框中，输入“**更新 index.html**”，然后选择“**创建分支：从‘主要’更新 index.html**”条目以创建新分支。
...
1. 在编辑器页面的右上角选择“**提交更改…**”。
1. 在“**提交更改**”窗口中，在“**扩展说明**”文本框中，输入“**修改图像和段落文本**”，接受默认提交消息，然后选择“**提交更改**”。
...
1. 在编辑器页面的右上角选择“**提交更改…**”。
1. 在“**提交更改**”窗口中，在“**扩展说明**”文本框中，输入“**修改 CSS 标记和选择器**”，接受默认提交消息，然后选择“**提交更改**”以提交对 update-index.html 分支的更改。
...
1. （可选）如果你有权访问 GitHub Copilot 以获取拉取请求功能，请在“**添加说明**”文本框中，单击“**Copilot 操作**”按钮，然后选择“**摘要**”（生成拉取请求中更改的摘要）。
   ...
   1. 生成摘要后，在“**添加说明**”在第一行输入“**寻址 #1**”，然后选择“**创建拉取请求**”。
...
1. 在“**添加说明**”文本框中，输入“**寻址 #1**”，然后选择“**创建拉取请求**”。
