...
请记住本模块的方案：你正在零售行业为软件开发公司工作，该公司正计划将其在线商店迁移到新应用，但由于开发和运营团队之间缺乏协作和沟通，在项目规划阶段遇到了困难。 由于你决定使用 GitHub 进行敏捷规划和管理，因此此实验室提供了创建 GitHub 存储库、关联的里程碑和问题、项目和项目板的机会。 此外，你将能够将草案项目添加到项目板和一个基于问题的项目，并查看自动化设置。
...
1. 在“新建里程碑”页上，执行以下操作：****
   ...
   - 在“标题”文本框中，输入“alpha 版本”********。
   - 在“截止日期（可选）”文本框中，输入当前日期前一周的日期****。
   - 在“说明”文本框中，输入“alpha 版本的完成版”********。

1. 选择“创建里程碑”****。
1. 重复最后三个步骤，以创建一个 **beta 版本** 里程碑，其截止日期比当前日期提前两周。 在“说明”文本框中，输入“beta 版本的完成版”********。
1. 导航回到“问题”页，然后选择“新建问题”********。
1. 在“添加标题”文本框中，输入“存储库自述文件页为空”********。
1. 在“添加说明”文本框中，输入“简洁性可能是一种美德，但此自述文件页面实际上可以使用一些文本”********。
...
1. 在“项目名称”文本框中，输入“DevOps Core 简介项目”********。
1. 在“简短说明”文本框中，输入“GitHub Projects 简介”并选择“保存”************。
1. 在“自述文件”部分中，输入以下文本****
...
1. 在“新建选项”窗口中的“标签文本”文本框中，输入“正在审阅”，然后选择要分配给列的颜色************。 在“说明”文本框中，输入“正在审阅此项目”，然后选择“保存”************。
...
1. 在“DevOps Core 简介项目”页上的 “Todo”列中，选择“+ 添加项”。************
1. 在文本框中，输入“需要其他协作者”****，然后按键盘上的 **Enter**。 这将向“Todo”列添加新的草稿项****。
...
1. 请注意，关闭该项会导致以下操作：
   ...
   - “alpha 版本”里程碑已标记为完成，如页面“里程碑”部分中的绿色水平栏指示********。
